...
targets = {
    ...
    'cores3_porta':   { 'colors': 'pin_table_colors', 'options': {'span_pin_name_without_usage': True , 'row_height': 24, 'pin_name_column_width': 24, 'usage_column_width': 40 }},
    'cores3_portb':   { 'colors': 'pin_table_colors', 'options': {'span_pin_name_without_usage': True , 'row_height': 24, 'pin_name_column_width': 24, 'usage_column_width': 40 }},
    'cores3_portc':   { 'colors': 'pin_table_colors', 'options': {'span_pin_name_without_usage': True , 'row_height': 24, 'pin_name_column_width': 24, 'usage_column_width': 40 }},
